...
// it nonnegative and of reasonably sized
#define SIZE 3
...
void input_data(int array[], int size); // inputs values for an array of length size


int main() {

	// These variables are used to make code a more readable
	...
	input_data(data1, SIZE); // call void function to input elements of the first array

	int data2[SIZE]; // second array
	input_data(data2, SIZE); // call void function to input elements of the first array
